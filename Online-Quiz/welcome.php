...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="http://127.0.0.1:5501/index.html"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
            ...
            <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>> <a href="http://localhost/login/Online-Quiz/welcome.php?q=1"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Test Board</a></li>
